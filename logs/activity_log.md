...
## Ghi chú thêm
- Khó khăn gặp phải:
Ban đầu em hơi khó phân biệt giữa Integrity và Confidentiality khi ghép các sự cố với mô hình CIA.
- Cách em xử lý:
Em đọc lại mô tả của từng thành phần trong mô hình CIA và so sánh với tình huống của đề bài để xác định đúng loại.
- Điều em học được từ bài lab:
Qua bài lab này em hiểu rõ hơn về ba yếu tố Confidentiality, Integrity và Availability trong bảo mật thông tin. 
